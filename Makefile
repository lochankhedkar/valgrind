...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	...
	$(dist_noinst_DATA) $(pkginclude_HEADERS) $(am__DIST_COMMON)
am__CONFIG_DISTCLEAN_FILES = config.status config.cache config.log \
 configure.lineno config.status.lineno
mkinstalldirs = $(install_sh) -d
CONFIG_HEADER = config.h
CONFIG_CLEAN_FILES = valgrind.spec valgrind.pc glibc-2.X.supp \
	glibc-2.X-helgrind.supp glibc-2.X-drd.supp \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/glibc-2.X-drd.supp.in \
	$(srcdir)/glibc-2.X-helgrind.supp.in \
	$(srcdir)/glibc-2.X.supp.in $(srcdir)/valgrind.pc.in \
...
ACLOCAL = ${SHELL} '/home/bhoomikahn/unmodified/valgrind-3.22.0/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /home/bhoomikahn/binutils-2.39/build/bin/ar
AUTOCONF = ${SHELL} '/home/bhoomikahn/unmodified/valgrind-3.22.0/missing' autoconf
AUTOHEADER = ${SHELL} '/home/bhoomikahn/unmodified/valgrind-3.22.0/missing' autoheader
AUTOMAKE = ${SHELL} '/home/bhoomikahn/unmodified/valgrind-3.22.0/missing' automake-1.16
AWK = gawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
LTO_AR = /home/bhoomikahn/binutils-2.39/build/bin/ar
LTO_CFLAGS = 
LTO_RANLIB = ranlib
MAINT = #
MAKEINFO = ${SHELL} '/home/bhoomikahn/unmodified/valgrind-3.22.0/missing' makeinfo
...
PACKAGE_STRING = Valgrind 3.22.0
...
VG_DATE = 31 Oct 2023
VG_GDBSCRIPTS_DIR = ${exec_prefix}/libexec/valgrind
VG_TMPDIR = /tmp
VG_VER_MAJOR = 3
VG_VER_MINOR = 22
XCODE_DIR = 
XCRUN = 
abs_builddir = /home/bhoomikahn/unmodified/valgrind-3.22.0
abs_srcdir = /home/bhoomikahn/unmodified/valgrind-3.22.0
abs_top_builddir = /home/bhoomikahn/unmodified/valgrind-3.22.0
abs_top_srcdir = /home/bhoomikahn/unmodified/valgrind-3.22.0
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/bhoomikahn/unmodified/valgrind-3.22.0/install-sh
...
pdfdir = ${docdir}
prefix = /home/bhoomikahn/unmodified/valgrind-3.22.0/build
...
AM_CPPFLAGS_ARM64_LINUX = -I$(top_srcdir) \
	-I$(top_srcdir)/include -I$(top_builddir)/include \
	-I$(top_srcdir)/VEX/pub -I$(top_builddir)/VEX/pub \
	-DVGA_arm64=1 -DVGO_linux=1 \
	-DVGP_arm64_linux=1 \
	-DVGPV_arm64_linux_vanilla=1 \
	$(am__append_3)
#AM_CPPFLAGS_ =  \
#	-I$(top_srcdir) \
...
AM_CFLAGS_PPC64LE_LINUX =  $(AM_CFLAGS_BASE) $(ISA_3_0_BUILD_FLAG)
AM_CFLAGS_PSO_PPC64LE_LINUX =  $(AM_CFLAGS_BASE) $(AM_CFLAGS_PSO_BASE)
AM_CCASFLAGS_PPC64LE_LINUX =  -g
AM_FLAG_M3264_X86_FREEBSD = 
AM_CFLAGS_X86_FREEBSD =   \
			      $(AM_CFLAGS_BASE) -fomit-frame-pointer

AM_CFLAGS_PSO_X86_FREEBSD =  $(AM_CFLAGS_BASE) $(AM_CFLAGS_PSO_BASE)
AM_CCASFLAGS_X86_FREEBSD =  -g
...
AM_FLAG_M3264_AMD64_FREEBSD = 
AM_CFLAGS_AMD64_FREEBSD =  \
				$(AM_CFLAGS_BASE) -fomit-frame-pointer

AM_CFLAGS_PSO_AMD64_FREEBSD =  $(AM_CFLAGS_BASE) $(AM_CFLAGS_PSO_BASE)
AM_CCASFLAGS_AMD64_FREEBSD =  -g
...
AM_FLAG_M3264_NANOMIPS_LINUX = 
AM_CFLAGS_NANOMIPS_LINUX =  $(AM_CFLAGS_BASE) -mno-jump-table-opt
AM_CFLAGS_PSO_NANOMIPS_LINUX =  $(AM_CFLAGS_BASE) \
				$(AM_CFLAGS_PSO_BASE)

AM_CCASFLAGS_NANOMIPS_LINUX =  -g
...
#
AM_FLAG_M3264_PRI = $(AM_FLAG_M3264_ARM64_LINUX)
AM_CPPFLAGS_PRI = $(AM_CPPFLAGS_ARM64_LINUX)
AM_CFLAGS_PRI = $(AM_CFLAGS_ARM64_LINUX)
AM_CCASFLAGS_PRI = $(AM_CCASFLAGS_ARM64_LINUX)
AM_FLAG_M3264_SEC = 
...
PRELOAD_LDFLAGS_X86_FREEBSD = $(PRELOAD_LDFLAGS_COMMON_FREEBSD) 
PRELOAD_LDFLAGS_AMD64_FREEBSD = $(PRELOAD_LDFLAGS_COMMON_FREEBSD) 
...
PRELOAD_LDFLAGS_NANOMIPS_LINUX = $(PRELOAD_LDFLAGS_COMMON_LINUX) 
...
DEFAULT_SUPP_FILES = ./xfree-3.supp ./xfree-4.supp glibc-2.X-drd.supp glibc-2.X-helgrind.supp glibc-2.X.supp 
...
glibc-2.X.supp: $(top_builddir)/config.status $(srcdir)/glibc-2.X.supp.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
glibc-2.X-helgrind.supp: $(top_builddir)/config.status $(srcdir)/glibc-2.X-helgrind.supp.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
glibc-2.X-drd.supp: $(top_builddir)/config.status $(srcdir)/glibc-2.X-drd.supp.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/xml/vg-entities.xml: $(top_builddir)/config.status $(top_srcdir)/docs/xml/vg-entities.xml.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
